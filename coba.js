...
const proxyListURL = 'https://raw.githubusercontent.com/Mayumiwandi/Emilia/refs/heads/main/Data/alive.txt';
const pagehost = '/'
const namaWeb = 'FREE PROXY LIFETIME'
const telegramku = 'https://t.me/@Yumi_yui'
const telegrambot = 'https://t.me/kcepu_bot'
const waku = 'https://github.com/Mayumiwandi'
const waku1 = 'https://github.com/Mayumiwandi'
const wildcards = [
  'quiz.int.vidio.com',
];
// Global Variables
...
/// ini bang___________________________________________________
...
@keyframes spinColors {
  ...
  animation: spin 1s linear infinite;
      ...
      * {
      ...
      body {
  background: url('https://github.com/user-attachments/assets/f37cee2b-b8a4-40c3-9366-8ddb46301a36') center fixed;
        background-size: cover;
        justify-content: center;
        align-items: center;
   /* Untuk animasi gradient */
