...
const serviceName = "alya"; // Ganti dengan nama workers kalian
const apiKey = "L4XCYvTino_phUDqul8-PctbHucSKvCuSf2_Wb1B"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens) 4nVTSeGWkH7WFBs9Ik0y0h67CJPuolmCyKTOJFhW
const apiEmail = "cagoki7756@asimarif.com"; // Ganti dengan email yang kalian gunakan Pustakadigitalyumi@gmail.com
const accountID = "5c89cd48761176267f34685cdf0e391e"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "a79643aea59e1713cf6cc9dce2717568"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
class CloudflareApi {
  constructor() {
    ...
    this.headers = {
      ...
      //"X-Auth-Email": this.apiEmail, Nonaktif
      //"X-Auth-Key": this.apiKey, Nonaktif
    };
  }
