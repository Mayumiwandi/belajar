...
// Variables
const rootDomain = "mayumiyui.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "yumiwolker"; // Ganti dengan nama workers kalian
...
const PROXY_HEALTH_CHECK_API = "https://yumiproxy.vercel.app/api/v1"; // Perbarui dengan URL baru
				  ...
				  .then(async (res) => {
					...
					if (res.status == 200) {
					  ...
					  if (jsonResp.proxyip === true) {
						isActive = true;
						pingElement.textContent = "Active " + jsonResp.delay + "";
